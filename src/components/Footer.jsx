...
const FooterSection = () => {
  return (
    <footer className="relative bg-[#F9F5F0] pt-22 overflow-hidden">
      {/* The Angled Footer Background */}
      <div className="relative">
        {/* Floating Circular Badge */}
        <div className="absolute -top-16 right-12 md:right-24 z-20">
          <div className="relative w-32 h-32 flex items-center justify-center bg-[#F7C0EB] rounded-full shadow-lg border-2 border-dashed border-pink-400 animate-spin-slow hover:pause">
             {/* Simplified version of the circular text */}
        ...
        >
          <div className="max-w-350 mx-auto grid grid-cols-1 md:grid-cols-12 gap-12 items-end">

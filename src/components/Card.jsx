...
const handleLeave = () => {
  ...
  return (
    <section className="bg-[#F9F5F0] pt-28 pb-28 px-4 overflow-hidden">
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:flex lg:flex-wrap items-center gap-4 py-10">
        {cards.map((card, index) => (
          <div
            ...
            className="relative w-full max-w-[calc(100vw-2rem)] sm:w-72 h-96 rounded-[2.5rem] overflow-hidden shadow-xl sm:-ml-4 sm:first:ml-0 cursor-pointer"
          >
            {card.type === 'color' ? (
